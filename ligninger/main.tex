...
\begin{figure}[h!]
\includegraphics[scale = 0.3]{BilderTilOppgaver/Grid.png}
\label{fig:grid}
\end{figure}
\newline
...
\newline\newline
\textbf{Oppgave 2} \newline
I denne oppgaven skal du finne stignigstallet til følgende lineær funksjoner. Fyll svaret i svarfeltet :
\begin{figure}[h!]
\includegraphics[scale = 0.4]{BilderTilOppgaver/Svarfelt.png}
\label{fig:grid}
\end{figure}
\begin{figure}[h!]
\includegraphics[scale = 0.4]{BilderTilOppgaver/3X.png}
\label{fig:grid}
\end{figure}
\begin{figure}[h!]
\includegraphics[scale = 0.35]{BilderTilOppgaver/3Xp2.png}
\label{fig:grid}
\end{figure}
\begin{figure}[h!]
\includegraphics[scale = 0.2]{BilderTilOppgaver/05Xp2.png}
\label{fig:grid}
\end{figure}
\end{document}
