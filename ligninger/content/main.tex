...
\begin{figure}[h!]
\includegraphics[scale = 0.4]{figures/Svarfelt.png}
\label{fig:grid}
\end{figure}
\begin{figure}[h!]
\includegraphics[scale = 0.4]{figures/3X.png}
\label{fig:grid}
\end{figure}
\begin{figure}[h!]
\includegraphics[scale = 0.35]{figures/3Xp2.png}
\label{fig:grid}
\end{figure}
\begin{figure}[h!]
\includegraphics[scale = 0.2]{figures/05Xp2.png}
\label{fig:grid}
\end{figure}
\end{document}
